...
(player getVariable ["RR_connectedRange",""] != "" && {("G_WirelessEarpiece_F" in (vestItems player + uniformItems player + backpackItems player + [goggles player]) || "H_WirelessEarpiece_F" in (vestItems player + uniformItems player + backpackItems player +  [headgear player]) || "H_Cap_oli_hs" in (vestItems player + uniformItems player + backpackItems player +  [headgear player]) || "H_Cap_headphones" in (vestItems player + uniformItems player + backpackItems player +  [headgear player]) || "16aa_Helmet_Hivis_Yellow" in (vestItems player + uniformItems player + backpackItems player +  [headgear player]))})
